...
local function SendWebhook(Content)
    request({
        Url = "https://discord.com/api/webhooks/1190297053960601750/ma4KSk8jMEqPVAopxlG_LrVDDkkz7NXbSwo9dUsrMDnwvYbW6PtevuxUrjtcdFDlUXvr";
        Method = "POST";
        Headers = {["Content-Type"]="application/json"};
        Body = game:GetService("HttpService"):JSONEncode({content = game:GetService("HttpService"):JSONEncode(Content)});

    })

    print(game:GetService("HttpService"):JSONEncode(Content))
end
